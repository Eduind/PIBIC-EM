<x-layout.layout-terciario>
    <x-slot:title>Exibir marca</x-slot:title>
    <x-slot:text>Marca - {{ $dados['marca']['nomeMarca'] }}</x-slot:text>
         ...
         <tr>
            ...
            <td>
                <div class='btn-wrapper'>
                    <a class="btn-atz"
                        href="{{ route('ExibirMarcaSubmit') .
                            '?' .
                            http_build_query([
                                'marca' => Crypt::encrypt($dados['marca']['idMarca']),
